		...
		if(sQuery.equals("JOIN")){
			...
			*/
			...
			sql = " SELECT CASE "
					 ...
					 + " (IFNULL(SUM(6TH), 0) + IFNULL(SUM(19TH), 0) + IFNULL(SUM(18TH_1),0)) / (CASE "
					 + "			WHEN SUM(6TH) IS NULL THEN 0 "
					 + "			ELSE 1 "
					 + "		END + "
					 + "		CASE "
					 + "			WHEN SUM(19TH) IS NULL THEN 0 "
					 + "			ELSE 1 "
					 + "		END + "
					 + "		CASE "
					 + "			WHEN SUM(18TH_1) IS NULL THEN 0 "
					 + "			ELSE 1"
					 + "		END) AS AVG"
					 + " FROM ( "
					 + " SELECT ADM_CD, "
			...
			String sql = " SELECT DISTINCT BN_SEQ,BKNAME AS KIND_STR,TITLE FROM BUSINESS_KIND A," 
